 ...
 */
module.exports = class MssqldbAdapter extends Module
{
    /**
 ...
 */
const getJoins = (ctx, fields, entity) =>
{
    const joins = [];
 ...
 * @param {any} completeCb Complete callback
 */
const execute = (ctx, query, successCb, completeCb) =>
{
 ...
 */
const ensurePoolInitialized = (ctx, callback) =>
{
    if(!!pool)
    {
        callback();
