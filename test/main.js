...
var tests = require('./tests/tests-main');
...
var mockMysqlConnectionPool = new MockConnectionPool("mysql");

tests(Orion, chai, runner, "data-mssql", mssqlAzureConfig, mockMssqlConnectionPool);